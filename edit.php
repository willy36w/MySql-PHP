...
<form action="store.php" method='post'>
    ...
    <div> 
        ...
        foreach($depts as $dept){
            ...
            $selected=($dept['id']==$user['dept'])?'selected':'';
               echo "<option value='{$dept['id']}' seletced>{$dept['name']}</option>";
        }
        ?>
        </select>
    </div> 
    ...
    <?php
        ...
        foreach($schools as $school){
            $selected=($school['id']==$user['gradute_at'])?'selected':'';
               echo "<option value='{$school['id']}' $seleted>{$school['county']}{$school['name']}</option>";
        }
    ?>
        </select>
    </div> 
